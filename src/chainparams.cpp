...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.TarpCoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.TarpCointools.com");
        vSeeds.emplace_back("dnsseed.TarpCoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.TarpCointools.com");
        vSeeds.emplace_back("seed-b.TarpCoin.loshan.co.uk");
