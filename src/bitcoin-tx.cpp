...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " TarpCoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  TarpCoin-tx [options] <hex-tx> [commands]  Update hex-encoded TarpCoin transaction\n" +
            "or:     TarpCoin-tx [options] -create [commands]   Create hex-encoded TarpCoin transaction\n" +
            "\n";
