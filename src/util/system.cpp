...
const char * const BITCOIN_CONF_FILENAME = "TarpCoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TarpCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TarpCoin";
#else
    // Unix
    return pathRet / ".TarpCoin";
#endif
#endif
}
