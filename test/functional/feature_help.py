...
"""Verify that starting TarpCoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start TarpCoin with -h for help text")
        ...
        self.log.info("Start TarpCoin with -version for version information")
        ...
        self.log.info("Start TarpCoind with -fakearg to make sure it does not start")
