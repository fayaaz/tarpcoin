# Support for Output Descriptors in TarpCoin Core

Since TarpCoin Core v0.17, there is support for Output Descriptors. This is a
...
on TarpCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing TarpCoin Core wallets, a convenience function `combo` is
